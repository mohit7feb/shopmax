...
<html lang="en">
  <head>
    <title>ShopMax &mdash; Contact Us</title>
    <meta charset="utf-8">
        ...
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              ...
              <p class="mb-0">3917 Spring Dr, Spring Valley, California(CA), 91977, USA</p>
            </div>
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">London</span>
              <p class="mb-0">807 Wandsworth Rd, Clapham, London, SW8 3JH, UK</p>
            </div>
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Toronto</span>
              <p class="mb-0">120 Bremner Blvd., Suite 800, Toronto, ON, M5J 0A8, Canada</p>
            </div>
