              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>Lip Mask <strong class="mx-2">x</strong> 1</td>
                        <td>$18.00</td>
                      </tr>
                      <tr>
                        <td>Face Powder <strong class="mx-2">x</strong>   1</td>
                        <td>$15.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
                        <td class="text-black">$33.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>$33.00</strong></td>
                      </tr>
                    </tbody>
                  </table>
